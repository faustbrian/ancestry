 ...
 * Morphism package's MorphKeyRegistry.
 *
 * ```php
...
final readonly class ModelRegistry
{
     ...
     *
     * @param MorphKeyRegistry $morphKeyRegistry The Morphism morph key registry dependency
     ...
     * relationships to use custom keys instead of assuming 'id'. Delegates to Morphism
