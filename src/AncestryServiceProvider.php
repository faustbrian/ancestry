...
final class AncestryServiceProvider extends PackageServiceProvider
{
    ...
    /**
     * Register variable key type mappings for Ancestry models.
     *
     * Maps Ancestor and AncestorSnapshot models to their configured primary key type,
     * enabling support for ULID, UUID, or auto-increment primary keys based on
     * the ancestry.primary_key_type configuration value.
     */
    ...
    private function configureMorphKeyMaps(): void
    {
        ...
        if ($hasMorphKeyMap && $hasEnforceMorphKeyMap) {
            throw ConflictingMorphKeyMapsException::detected();
        }
