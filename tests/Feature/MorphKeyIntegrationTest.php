...
beforeEach(function (): void {
    ...
    $ancestorMorphType = config('ancestry.ancestor_morph_type', 'morph');
    $descendantMorphType = config('ancestry.descendant_morph_type', 'morph');
...
describe('MorphKeyIntegration', function (): void {
    ...
    describe('Custom Key Mapping', function (): void {
        test('uses mapped key name for ancestor/descendant id', function (): void {
            ...
            if (in_array(config('ancestry.ancestor_morph_type', 'morph'), ['numericMorph', 'uuidMorph', 'ulidMorph'], true)) {
