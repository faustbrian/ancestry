...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function defineEnvironment($app): void
    {
        ...
        $app['config']->set('ancestry.ancestor_morph_type', env('ANCESTRY_ANCESTOR_MORPH_TYPE', 'morph'));
        $app['config']->set('ancestry.descendant_morph_type', env('ANCESTRY_DESCENDANT_MORPH_TYPE', 'morph'));
        ...
        $app['config']->set('ancestry.snapshots.context_morph_type', env('ANCESTRY_SNAPSHOTS_CONTEXT_MORPH_TYPE', 'morph'));
